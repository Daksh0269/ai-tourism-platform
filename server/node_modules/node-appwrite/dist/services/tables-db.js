...
class TablesDB {
  ...
  createMigration(paramsOrFirst, ...rest) {
    ...
    if (typeof specification === "undefined") {
      throw new client.AppwriteException('Missing required parameter: "specification"');
    }
    const apiPath = "/tablesdb/{databaseId}/migrations".replace("{databaseId}", encodeURIComponent(String(databaseId)));
    const payload = {};
    if (typeof specification !== "undefined") {
  ...
  getMigration(paramsOrFirst, ...rest) {
    ...
    if (typeof migrationId === "undefined") {
      throw new client.AppwriteException('Missing required parameter: "migrationId"');
    }
  ...
  cutoverMigration(paramsOrFirst, ...rest) {
    let params;
    if (paramsOrFirst && typeof paramsOrFirst === "object" && !Array.isArray(paramsOrFirst)) {
      params = paramsOrFirst || {};
    } else {
